...
MPOWA_CHECKBUTTON_PET = "Pet"
MPOWA_CHECKBUTTON_PET_TOOLTIP = "Check this to use the pet instead of you."
MPOWA_EDITBOX_PET_NAME = "Pet name:"
MPOWA_EDITBOX_PET_NAME_TOOLTIP = "Exact name of the pet (optional)"
